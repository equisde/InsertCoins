...
public:
    ...
    void setupUi(QDialog *CoinControlDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 Insertcoins"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 Insertcoins"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 Insertcoins"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 Insertcoins"));
